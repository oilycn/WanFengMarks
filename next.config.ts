...
const nextConfig: NextConfig = {
  ...
  // It should also match the 'Origin' header from the browser.
  ...
  // (often due to host/origin/port mismatch), ensure your Nginx Proxy Manager is sending:
  ...
  // you would add custom Nginx directives like:
  //   proxy_set_header X-Forwarded-Proto https;
  ...
  // If your NPM setup has `forward_scheme: "http"`, it might not be sending `X-Forwarded-Proto https` by default unless you explicitly add it.
};
